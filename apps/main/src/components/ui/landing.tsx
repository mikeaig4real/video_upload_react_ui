...
export const ScreenShotTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
...
export const SkeletonOne = ({ img_src = "/linear.webp" }) => {
  return (
...
export const SkeletonThree = ({
  img_src = "https://assets.aceternity.com/fireship.jpg",
  video_link = "https://www.youtube.com/watch?v=RPa3_AD1_Vs",
}) => {
  return (
    <a
      href={video_link}
...
interface FlipCodeSkeletonProps {
  embedCode: string;
  iframeSrc: string;
}

export const FlipCodeSkeleton: React.FC<FlipCodeSkeletonProps> = ({
  embedCode,
  iframeSrc,
}) => {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto">
      ...
      <div className="relative h-[400px] w-full perspective">
        <AnimatePresence mode="wait" initial={false}>
          {showCode ? (
            <motion.div
              ...
              className="absolute inset-0 backface-hidden overflow-auto text-left"
            >
              <CodeBlockDemo
                files={[
                  {
